...
SELECT CO.ORDER_ID,
	...
	CASE
					...
					ELSE CAST(REGEXP_REPLACE(CO.EXCLUSIONS,
	...
	CASE
					...
					ELSE CAST(REGEXP_REPLACE(CO.EXTRAS,
	...
	RO.RUNNER_ID,
	R.REGISTRATION_DATE,
	CAST(NULLIF(RO.PICKUP_TIME,

							'null') AS TIMESTAMP WITHOUT TIME ZONE) AS PICKUP_TIME,
	CASE
					WHEN RO.DISTANCE = ''
										OR RO.DISTANCE = 'null' THEN NULL
					ELSE CAST(REGEXP_REPLACE(RO.DISTANCE,
	...
	CASE
					WHEN RO.DURATION = ''
										OR RO.DURATION = 'null' THEN NULL
					ELSE CAST(REGEXP_REPLACE(RO.DURATION,
	...
	CASE
					WHEN RO.CANCELLATION = ''
										OR RO.CANCELLATION = 'null' THEN NULL
